...
Процедура ОпросСервераНаНаличеДанныхОМарках(СтруктураДанных)
	ДатаОкончанияОпроса=ТекущаяДатаСеанса()+500;
	Шаг=30;
	ДатаЗАпросаНаСервер=ТекущаяДатаСеанса()+10;	 
	Пока ТекущаяДатаСеанса()<=ДатаОкончанияОпроса Цикл
		Если ТекущаяДатаСеанса()>=ДатаЗАпросаНаСервер Тогда 
